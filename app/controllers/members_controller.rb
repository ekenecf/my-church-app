class MembersController < ApplicationController
    ...
    def create
        ...
        created_member = Member.new(name: params[:name], phone_number: params[:phone_number], occupation: params[:occupation], picture: params[:picture], distance: params[:distance], active: params[:active], post_held: params[:post_held], birthday: params[:birthday])
        @user = User.find(params[:user_id])
  ...
  def member_params
    params.require(:deal).permit(:name, :phone_number, :occupation, :picture, :distance, :active, :post_held, :birthday, :group_id)
  end
end
